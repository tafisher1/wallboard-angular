...
function checkImageSectionWithUrl(id) {
    ...
    expect(viewEmployeePage.getImageUrlField().getText())
        .toEqual('Image Url : /image/' + id + '.jpg');
...
function checkContactInfoSection(id) {
    ...
    expect(viewEmployeePage.getEmailField().getText()).toEqual('Email : Email' + id);
    expect(viewEmployeePage.getWorkPhoneField().getText()).toEqual('Work Phone : Work Phone' + id);
    expect(viewEmployeePage.getCellPhoneField().getText()).toEqual('Cell Phone : Cell Phone' + id);
}
